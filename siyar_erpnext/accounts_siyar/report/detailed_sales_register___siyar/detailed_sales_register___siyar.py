...
def get_columns():
	return [
		...
		"Amount With:Currency/currency:80",
		"Rebate %:Float:80",
...
def get_valuation_rate(invoice, item):
	...
	""", {"item_code": item.item_code, "warehouse": item.warehouse, "posting_date": invoice.posting_date, "posting_time": invoice.posting_time}, debug=True)
