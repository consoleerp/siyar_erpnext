...
def execute(filters=None):
	...
	for sle in sl_entries:
		...
		if sle.voucher_type == "Sales Invoice":
			party = frappe.db.get_value("Sales Invoice", sle.voucher_no, "customer")
			selling_price = frappe.db.get_value("Sales Invoice Item", filters={'parent': sle.voucher_no, 'item_code': sle.item_code}, fieldname="consoleerp_customer_rate")
		elif sle.voucher_type == "Purchase Invoice":
			party = frappe.db.get_value("Purchase Invoice", sle.voucher_no, "supplier")
